...
class NytimesTest < Minitest::Test
  ...
  def test_it_can_get_all_stories_with_subsection_of_politics
    ...
    first_story = "Congressional G.O.P. Agenda Quietly Falls Into Place Even as Trump Steals the Spotlight"
    assert_equal first_story, result.first[:title]

    last_story = "Conspiracy Theories Made Alex Jones Very Rich. They May Bring Him Down."
    assert_equal last_story, result.last[:title]
  end
end
